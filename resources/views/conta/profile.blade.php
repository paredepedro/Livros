                ...
                <div class="row" style="padding: 1%">
                    <div class="col">
                        <div style="background-color: #19191a; border-radius: 10px;">
                            ...
                            <!-- Primeira row: imagem do usuario, nome do usuario + tag -->
                            <div class="row" style="padding:5%">
                                <div class="col">
                                    <svg id="iconUser" type="submit" xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="white" class="bi bi-person-circle" viewBox="0 0 16 16">
                                    <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z"/>
                                    <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1z"/>
                                    </svg>
                                ...
                                <div class="col">
                                    ...
                                    <button type="button" class="btn" style="background-color:#F96513">mod</button>
                                </div>
                            </div>
                            
                            <!-- Segunda Row: , follow, livros lidos + Sobre o usuario -->
                            <div class="row" >
                                <div class="col">
                                    <center>
                                    <div class="btn-group-vertical" role="group" aria-label="Basic outlined example">
                                        <button type="button" class="btn btn-outline-dark" style="background-color:#F96513">follow</button>
                                        <button type="button" class="btn btn-outline-dark" style="background-color:#F96513">Livros lidos</button>
                                    </div>
                                    </center>
                                </div>

                                <div class="col-7">
                                    <div style="height:130px; width:330px; background-color:#292929; margin-bottom: 5%; border-radius: 10px;">
                                        <font color="white" size="-1" >
                                            <p align="justify">Mais um guerreiro da Maior Tribo do Mundo! Atuei como jogador profissional de CS por quase uma década, fui o primeiro treinador a ser campeão do mundo em 2007 com o MIBR. Acertei um pouco, errei muito, ganhei bastante coisa e tbm perdi demais! Atualmente faço live todos os dias aqui na Twitch!</p>
                                        </font>
                                    </div>
                        ...
                        <!-- div post e avaliações -->
                        <div class="row" style="margin-top:5%;margin-bottom:5%;">
                            
                            <div class="col">
                                <center style="border-bottom: 10px solid #19191a">Post</center>
                            </div>
                            <div class="col">
                                <center>Avaliacao</center>
                            </div>
                        </div>

                        <!-- div conteudo de post e de avalicao -->
                            ...
                            <div style="border-top-left-radius: 10px;border-top-right-radius: 10px; background-color: #19191a">
                                <div class="row">
                                    ...
                                    <div class="col" style="margin:1%">
                                        <font color="white" size="+2">Tag:</font>
                                        <button type="button" class="btn" style="background-color:#F96513">resenha</button>
                                    </div>
                                    <div class="col-1">
                                        <button class="btn">
